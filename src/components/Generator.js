  ...
  return (
    <div className="flex flex-col gap-4">
      <div className="flex items-center justify-center gap-2">
        <p className="text-3xl font-semibold sm:text-4xl md:-5xl text-slate-400">{index}</p>
...
const Generator = ({poison,muscles,goal,setgoal,setmuscles,setpoison,updateWorkout}) => {
